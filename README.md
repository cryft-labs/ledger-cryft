...
[![GithubActions](https://github.com/cryft-labs/ledger-avalanche/actions/workflows/main.yaml/badge.svg)](https://github.com/cryft-labs/ledger-avalanche/blob/main/.github/workflows/main.yaml)
...
Download a release from here (https://github.com/cryft-labs/ledger-avalanche/releases). You only need `installer_s.sh`
